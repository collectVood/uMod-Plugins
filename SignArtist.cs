...
{
    [Info("Sign Artist", "Whispers88 / EDITED by collect_vood#3773", "1.1.9", ResourceId = 992)]
    [Description("Allows players with the appropriate permission to import images from the internet on paintable objects")]

    /*********************************************************************************
     * THIS PLUGIN HAS BEEN EDITED BY collect_vood#3773
     * 
     * 
     * 
    ...
    internal class SignArtist : RustPlugin
    {
        ...
        /// <summary>
        /// Can be called to skin a defined sign
        /// </summary>
        /// <param name="sign"></param>
        /// <param name="url"></param>
        /// <returns></returns>
        private void API_SkinSign(Signage sign, string url, bool raw = false)
        {
            if (sign == null)
            {

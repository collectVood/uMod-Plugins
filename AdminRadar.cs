...
/*
    Custom Admin Radar Version edited by collect_vood#3773
*/

namespace Oxide.Plugins
{
    [Info("Admin Radar", "nivex / EDITED BY collect_vood", "5.0.9")]
    ...
    class AdminRadar : RustPlugin
    {
        ...
        private class CachedInfo
        {
            ...
            public Network.Visibility.Group Group;
        }
        ...
        private class Radar : FacepunchBehaviour
        {
            ...
            private int ShowActive()
            {
                ...
                try
                {
                    ...
                    {
                        if (target == null || target.transform == null || !target.IsConnected || player.net.group != target.net.group)
                        {
                            continue;
                        }
            ...
            private int ShowSleepers()
            {
                ...
                try
                {
                    ...
                    {
                        if (sleeper == null || sleeper.transform == null || player.net.group != sleeper.net.group)
                            continue;
            ...
            private int ShowHeli()
            {
                ...
                try
                {
                    if (cache.Helicopters.Count > 0)
                    {
                        ...
                        {
                            if (heli == null || heli.transform == null || heli.IsDestroyed || player.net.group != heli.net.group)
                                continue;
            ...
            private int ShowBradley()
            {
                ...
                try
                {
                    if (cache.BradleyAPCs.Count > 0)
                    {
                        ...
                        {
                            if (bradley == null || bradley.transform == null || bradley.IsDestroyed || player.net.group != bradley.net.group)
                                continue;
            ...
            private int ShowTC()
            {
                ...
                try
                {
                    foreach (var tc in cache.Cupboards)
                    {
                        if (tc == null || tc.transform == null || tc.IsDestroyed || tc.net.group != player.net.group)
                        {
                            tcs.Remove(tc);
                            continue;
                        }
            ...
            private int ShowContainers()
            {
                ...
                try
                {
                    if (showLoot)
                    {
                        ...
                        {
                            if (backpack == null || backpack.transform == null || backpack.IsDestroyed || backpack.net.group != player.net.group)
                                continue;
            ...
            private int ShowBags()
            {
                ...
                try
                {
                    ...
                    {
                        if (bag.Value.Group != player.net.group)
                            continue;
            ...
            private int ShowTurrets()
            {
                ...
                try
                {
                    ...
                    {
                        if (turret.net.group != player.net.group)
                            continue;
            ...
            private int ShowDead()
            {
                ...
                try
                {
                    ...
                    {
                        if (corpse.Key == null || corpse.Key.transform == null || corpse.Key.IsDestroyed || corpse.Key.net.group != player.net.group)
                            continue;
            ...
            private int ShowNPC()
            {
                ...
                try
                {
                    ...
                    {
                        if (zombie == null || zombie.transform == null || zombie.IsDestroyed || zombie.net.group != player.net.group)
                            continue;
                    ...
                    {
                        if (target == null || target.transform == null || target.IsDestroyed || target.net.group != player.net.group)
                            continue;
            ...
            private int ShowOre()
            {
                ...
                try
                {
                    ...
                    {
                        if (ore.Value.Group != player.net.group)
                            continue;
            ...
            private int ShowCCTV()
            {
                ...
                try
                {
                    ...
                    {
                        if (cctv.net.group != player.net.group)
                            continue;
            ...
            private int ShowCollectables()
            {
                ...
                try
                {
                    ...
                    {
                        if (col.Value.Group != player.net.group)
                            continue;
            ...
            private int ShowEntity(EntityType entityType, bool track, string entityName, List<BaseEntity> entities)
            {
                ...
                try
                {
                    if (entities.Count > 0)
                    {
                        ...
                        {
                            if (e == null || e.transform == null || e.IsDestroyed || player.net.group != e.net.group)
                                continue;
        ...
        private bool AddToCache(BaseEntity entity)
        {
            ...
            else if (trackCollectibles && entity is CollectibleEntity)
            {
                if (!cache.Collectibles.ContainsKey(position))
                {
                    ...
                    cache.Collectibles.Add(position, new CachedInfo { Name = _(entity.ShortPrefabName), Size = 0.5f, Info = sum, Group = entity.net.group });
                    return True;
                }
            ...
            else if (trackOre && entity is OreResourceEntity)
            {
                if (!cache.Ores.ContainsKey(position))
                {
                    ...
                    cache.Ores.Add(position, new CachedInfo { Name = _(entity.ShortPrefabName), Info = amount, Group = entity.net.group });
                    return True;
                }
            ...
            else if (trackDead && entity is PlayerCorpse)
            {
                ...
                if (!cache.Corpses.ContainsKey(corpse) && corpse.playerSteamID.IsSteamId())
                {
                    ...
                    cache.Corpses.Add(corpse, new CachedInfo { Name = corpse.parentEnt?.ToString() ?? corpse.playerSteamID.ToString(), Info = contents, Group = entity.net.group });
                    return True;
                }
            ...
            else if (trackBags && entity is SleepingBag)
            {
                ...
                {
                    cache.Bags.Add(position, new CachedInfo { Size = 0.5f, Group = entity.net.group });
                    return True;
                }
